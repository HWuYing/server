...
exports.Entity = (0, di_1.makeDecorator)(constant_1.ENTITY, function (tableName, options) { return (tslib_1.__assign({ tableName: tableName }, options)); }, getFactoryEntity);
...
exports.Column = (0, di_1.makePropDecorator)(constant_1.COLUMN, function (type, options) { return columnProps(tslib_1.__assign({ type: type }, options)); });
