            ...
            return __generator(this, function (_f) {
                switch (_f.label) {
                    ...
                    case 3:
                        ...
                        (_e = get(router, metadataName)).call.apply(_e, __spreadArray([router], params.concat.apply(params, __spreadArray(__spreadArray([], middleware, false), [map.get(method)], false)), false));
                        _f.label = 4;
                    case 4:
                        _i++;
                        return [3 /*break*/, 1];
