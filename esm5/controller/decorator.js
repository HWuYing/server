...
export var Patch = makeMethodDecorator(RequestMethod.patch, methodProps);
export var Trace = makeMethodDecorator(RequestMethod.trace, methodProps);
...
export var Connect = makeMethodDecorator(RequestMethod.connect, methodProps);
...
export var Header = makeMethodDecorator(ResponseHeader.header, function (key, value) { return ({ key: key, value: value }); });
export var ContentType = makeMethodDecorator(ResponseHeader.header, function (type) { return ({ key: 'Content-Type', type: type }); });
...
export var Params = makeParamDecorator(RouterParams.param, paramsProps);
